...
impl Actor {
    ...
    where
        ...
        RT: Runtime<BS>,
    {
        extend_sector_inner(rt, &params.extensions, extend_commitment)
    }
    ...
    RT: Runtime<BS>,
{
    ...
    validate_commitment_expiration(rt, sector.activation, decl.new_expiration, sector.seal_proof)?;
